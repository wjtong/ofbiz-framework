...
public class EdmConfigLoader {
    ...
    public static EdmWebConfig loadAppEdmConfig(Delegator delegator, LocalDispatcher dispatcher,
        ...
        createDraftTable(edmWebConfig, delegator);
        return edmWebConfig;
    }
...
//                    return;
    ...
    private static OfbizCsdlEntityType loadEntityTypeFromElement(Delegator delegator, LocalDispatcher dispatcher,
        ...
        String useAttributeAttr = entityTypeElement.getAttribute("UseAttribute");
        if (UtilValidate.isNotEmpty(useAttributeAttr)) {
            useAttribute = true;
        }
        ...
        for (Element inEntityElement : entityTypeChildren) {
            ...
            if (inEntityTagName.equals("RelAlias")) {
                ...
                OfbizCsdlProperty csdlProperty = loadPropertyFromElement(dispatcher, modelEntity, relAliases, inEntityElement, locale);
    ...
    private static OfbizCsdlComplexType loadComplexTypeFromElement(LocalDispatcher dispatcher,
        ...
        for (Element inComplexElement : complexTypeChildren) {
            ...
            if (inComplexTagName.equals("Property")) {
                CsdlProperty csdlProperty = loadPropertyFromElement(dispatcher, null, null, inComplexElement, locale);
...
//                String relationConditionStr = relation.substring(relation.indexOf('(') + 1, relation.indexOf(')'));
    ...
    public synchronized static void createDraftTable(EdmWebConfig edmWebConfig, Delegator delegator) throws GenericEntityException {
        ...
        for (OfbizCsdlEntityType entityType : edmWebConfig.getEntityTypes()) {
            ...
            for (CsdlProperty property : properties) {
                ...
                if (!modelEntity.isField(property.getName())) {
